...
import com.example.y_xl.neihanduanzi.model.bean.ShangChuanBean;
...
//    private String token = "EDBC3B54F2E9E375E50A76E8E3F8ECA0472E4E3D63DCE47F388F778CA6C17483";  // 用户令牌
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quarter_publish);
    ...
    public void shangChuanVideo(){
        if(!latitude.equals("")&&!longitude.equals("")){
             ...
             *
             */
            io.reactivex.Observable<String> responseBodyCall = apiService.uploadFile(newUrl,description,body,description1,body1);
            ...
            responseBodyCall.subscribeOn(Schedulers.io())
                    ...
                    .subscribe(new BaseObserver() {
                        ...
                        public void onSuccess(String result) {
                            ...
                            Log.i("onSuccess", "onSuccess: "+shangChuanBean.getMsg());
                        }
